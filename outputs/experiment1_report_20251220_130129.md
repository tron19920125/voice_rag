...
本实验对比了 Qwen/Qwen3-14B 模型在有/无 RAG 支持下的表现。

### 测试矩阵
- **测试场景**: 6 个
- **测试模型**: 1 个 (Qwen/Qwen3-14B)
...
|------|--------|--------|----------|
| Qwen/Qwen3-14B | 62.66 | 71.82 | +9.15 |
...
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-14B | 无 RAG | 58.8 | 6.2 | 10.0 | 2.0 | 7.0 |
| Qwen/Qwen3-14B | 有 RAG | 70.0 | 10.0 | 10.0 | 2.0 | 7.0 |
...
| 模型 | 模式 | 总分 | 准确性 | 完整性 | 推理 | 精确性 |
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-14B | 无 RAG | 73.4 | 7.1 | 10.0 | 6.0 | 7.0 |
| Qwen/Qwen3-14B | 有 RAG | 82.0 | 10.0 | 10.0 | 6.0 | 7.0 |
...
| 模型 | 模式 | 总分 | 准确性 | 完整性 | 推理 | 精确性 |
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-14B | 无 RAG | 52.9 | 4.3 | 10.0 | 2.0 | 7.0 |
| Qwen/Qwen3-14B | 有 RAG | 73.4 | 7.1 | 10.0 | 6.0 | 7.0 |
...
| 模型 | 模式 | 总分 | 准确性 | 完整性 | 推理 | 精确性 |
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-14B | 无 RAG | 62.0 | 3.3 | 10.0 | 6.0 | 7.0 |
| Qwen/Qwen3-14B | 有 RAG | 67.0 | 5.0 | 10.0 | 6.0 | 7.0 |
...
| 模型 | 模式 | 总分 | 准确性 | 完整性 | 推理 | 精确性 |
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-14B | 无 RAG | 60.0 | 6.7 | 10.0 | 2.0 | 7.0 |
| Qwen/Qwen3-14B | 有 RAG | 72.0 | 6.7 | 10.0 | 6.0 | 7.0 |
...
| 模型 | 模式 | 总分 | 准确性 | 完整性 | 推理 | 精确性 |
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-14B | 无 RAG | 68.9 | 7.6 | 10.0 | 4.0 | 7.0 |
| Qwen/Qwen3-14B | 有 RAG | 66.5 | 8.8 | 10.0 | 2.0 | 7.0 |
