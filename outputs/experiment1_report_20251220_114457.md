...
本实验对比了 Qwen/Qwen3-8B 模型在有/无 RAG 支持下的表现。

### 测试矩阵
- **测试场景**: 6 个
- **测试模型**: 1 个 (Qwen/Qwen3-8B)
...
|------|--------|--------|----------|
| Qwen/Qwen3-8B | 60.67 | 71.79 | +11.12 |
...
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-8B | 无 RAG | 58.8 | 6.2 | 10.0 | 2.0 | 7.0 |
| Qwen/Qwen3-8B | 有 RAG | 76.0 | 10.0 | 10.0 | 4.0 | 7.0 |
...
| 模型 | 模式 | 总分 | 准确性 | 完整性 | 推理 | 精确性 |
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-8B | 无 RAG | 67.4 | 7.1 | 10.0 | 4.0 | 7.0 |
| Qwen/Qwen3-8B | 有 RAG | 76.0 | 10.0 | 10.0 | 4.0 | 7.0 |
...
| 模型 | 模式 | 总分 | 准确性 | 完整性 | 推理 | 精确性 |
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-8B | 无 RAG | 57.1 | 5.7 | 10.0 | 2.0 | 7.0 |
| Qwen/Qwen3-8B | 有 RAG | 73.4 | 7.1 | 10.0 | 6.0 | 7.0 |
...
| 模型 | 模式 | 总分 | 准确性 | 完整性 | 推理 | 精确性 |
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-8B | 无 RAG | 56.0 | 3.3 | 10.0 | 4.0 | 7.0 |
| Qwen/Qwen3-8B | 有 RAG | 66.0 | 6.7 | 10.0 | 4.0 | 7.0 |
...
| 模型 | 模式 | 总分 | 准确性 | 完整性 | 推理 | 精确性 |
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-8B | 无 RAG | 60.0 | 6.7 | 10.0 | 2.0 | 7.0 |
| Qwen/Qwen3-8B | 有 RAG | 69.3 | 7.8 | 10.0 | 4.0 | 7.0 |
...
| 模型 | 模式 | 总分 | 准确性 | 完整性 | 推理 | 精确性 |
|------|------|------|--------|--------|------|--------|
| Qwen/Qwen3-8B | 无 RAG | 64.7 | 8.2 | 10.0 | 2.0 | 7.0 |
| Qwen/Qwen3-8B | 有 RAG | 70.0 | 10.0 | 10.0 | 2.0 | 7.0 |
